...
| THR-027 | Partial provisioning failure | Provisioning | Directory/container created but API reports success or retries unsafely. | Orphaned resources, duplicate/conflicting identity, data loss. | Medium | High | GH-09 checkpoints unknown effects; GH-11/GH-12 provide trusted inspection; ARCH-03 atomically applies reconciler evidence, audits it, authorizes only bounded absent-effect retries and keeps ambiguous mutations active. | No automatic orchestration or safe owned-resource deletion/rollback. | Explicit recovery orchestration and owned-resource rollback. | GH-15 |
