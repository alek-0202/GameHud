...
Palworld__Updates__StartupVerificationTimeoutSeconds=${GAMESHUD_PALWORLD_UPDATES_STARTUP_VERIFICATION_TIMEOUT_SECONDS}
Palworld__Updates__VerificationRetryDelayMilliseconds=${GAMESHUD_PALWORLD_UPDATES_VERIFICATION_RETRY_DELAY_MILLISECONDS}
